...
def email_verification(form, field): 
    email = field.data
    if "utoronto.ca" not in email:
        raise ValidationError("Email must be a valid utoronto email address")
...
class NameForm(FlaskForm):
    ...
    email= StringField('What is your UofT email address?', validators=[
        ...
        Email(message="Please include an '@' in the email address."), email_verification])
